...
- Nos versos da musica, substitua a palavra-lacuna por ___ e coloque a palavra correta em blank_word
- Se uma secao nao existir no texto, use null ou array vazio
- Responda SOMENTE com o JSON, sem markdown ou explicacoes
...
export default function ImportLessonPage({ params }: { params: { moduleId: string } }) {
  ...
  function handleParse() {
    ...
    try {
      ...
      setParseError('JSON invalido: ' + (e as Error).message)
    }
  }
      ...
      {lesson && (
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-2 p-4 bg-[#ecfdf5] border border-[#bbf7d0] rounded-xl">
            ...
            <p className="text-sm font-medium text-[#065f46]">JSON valido! Revise abaixo e crie a aula como rascunho.</p>
          </div>

          <Section title="Informacoes basicas">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <p className="text-[10px] font-medium text-[#94a3b8] uppercase tracking-wide mb-1">Titulo</p>
          ...
          {lesson.song_exercise?.song_title && (
            <Section title="Exercicio de Musica">
          ...
          {lesson.questions.length > 0 && (
            <Section title="Perguntas de Conversacao">
